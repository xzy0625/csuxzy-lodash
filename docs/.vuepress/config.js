...
module.exports = {
  ...
  themeConfig: {
    nav: [
      { text: '首页', link: '/' },
      {
        text: '指南', link: '/pages/introduce/', items: [
    ...
    repo: 'xzy0625/csuxzy-lodash', // 导航栏右侧生成Github链接
    ...
    author: { // 文章默认的作者信息，可在md文件中单独配置此信息 String | {name: String, href: String}
      name: 'csu-xzy', // 必需
      href: 'https://github.com/xzy0625' // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:2358460586@qq.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/xzy0625'
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: { // 页脚信息
      ...
      copyrightInfo: 'CSU-XZY | MIT License', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
